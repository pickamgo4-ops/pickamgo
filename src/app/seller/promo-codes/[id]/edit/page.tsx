...
export default function EditSellerPromoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await api.updateSellerPromo(params.id as string, payload)
      if (res.success) {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-warm-800/60 text-sm mt-1">Update your promotion settings</p>
          </div>
        </div>
