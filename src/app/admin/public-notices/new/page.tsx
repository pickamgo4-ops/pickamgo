...
export default function NewPublicNoticePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post("/public-notices", payload);
      if (response.success) {
      ...
      <div className="flex-1 min-w-0 md:ml-64 overflow-y-auto">
        <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-md border-b border-warm-200 px-4 py-3 md:hidden">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-warm-900">New Public Notice</h1>
          </div>
        </header>
        ...
        <main className="p-4 md:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="font-display text-3xl font-bold text-warm-900">New Public Notice</h1>
                <p className="text-warm-800/60 mt-1">Create a new public notice for the platform</p>
              </div>
            </div>
