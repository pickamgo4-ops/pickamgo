...
export const defaultPlatformTheme: PlatformTheme = {
  light: {
    pageBackground: '#FFFFFF', surfaceBackground: '#FFFFFF', surfaceSecondary: '#FFFFFF', primaryBrand: '#1769D1', primaryHover: '#0B4EA2', secondaryBrand: '#258DD8', accent: '#35A9E8', textColor: '#102A43', secondaryText: '#23466B', mutedText: '#58708A', border: '#CBD5E1', inputBackground: '#FFFFFF', inputBorder: '#94A3B8', buttonBackground: '#1769D1', buttonText: '#FFFFFF', linkColor: '#0B4EA2', success: '#2E8B57', warning: '#B7791F', error: '#C53030', info: '#2B6CB0', badgeBackground: '#FFFFFF', badgeText: '#0B4EA2', headerBackground: '#FFFFFF', footerBackground: '#102A43', sidebarBackground: '#FFFFFF', sidebarText: '#23466B', sidebarActive: '#FFFFFF', modalOverlay: '#102A4370',
  },
  dark: {
    pageBackground: '#121A24', surfaceBackground: '#192535', surfaceSecondary: '#223449', primaryBrand: '#35A9E8', primaryHover: '#1769D1', secondaryBrand: '#258DD8', accent: '#7DD3FC', textColor: '#F5F9FC', secondaryText: '#D4E7F5', mutedText: '#A8C0D4', border: '#334B63', inputBackground: '#1D2B3A', inputBorder: '#4B657E', buttonBackground: '#35A9E8', buttonText: '#071A33', linkColor: '#7DD3FC', success: '#68D391', warning: '#F6C453', error: '#FC8181', info: '#63B3ED', badgeBackground: '#243B53', badgeText: '#D4E7F5', headerBackground: '#142231', footerBackground: '#0B1724', sidebarBackground: '#142231', sidebarText: '#D4E7F5', sidebarActive: '#23466B', modalOverlay: '#071A33A6',
  },
}
