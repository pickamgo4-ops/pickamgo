...
export const defaultPlatformTheme: PlatformTheme = {
  light: {
    pageBackground: '#FFFBF5', surfaceBackground: '#FFFFFF', surfaceSecondary: '#FFF5E6', primaryBrand: '#FF6B35', primaryHover: '#E85D2E', secondaryBrand: '#FFB347', accent: '#FF8C5A', textColor: '#2C1F15', secondaryText: '#4A3728', mutedText: '#6B5C52', border: '#E8DCCF', inputBackground: '#FFFFFF', inputBorder: '#D9C9BA', buttonBackground: '#FF6B35', buttonText: '#FFFFFF', linkColor: '#D94E22', success: '#2E8B57', warning: '#B7791F', error: '#C53030', info: '#2B6CB0', badgeBackground: '#FFF0E8', badgeText: '#B83E1A', headerBackground: '#FFFFFF', footerBackground: '#2C1F15', sidebarBackground: '#FFFFFF', sidebarText: '#4A3728', sidebarActive: '#FFF0E8', modalOverlay: '#2C1F1570',
  },
  dark: {
